...
export function OnCallPersonSelector({
  people,
  currentUserId,
  monthKey,
}: {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="end" className="w-[min(23rem,calc(100vw-2rem))] gap-3 p-3">
        <PopoverHeader>
          <PopoverTitle>Selecionar pessoa</PopoverTitle>
          <PopoverDescription>
            Consulte a escala de uma pessoa do seu espaço.
          </PopoverDescription>
        </PopoverHeader>
        ...
        <div className="max-h-72 space-y-1 overflow-y-auto" role="listbox">
          {filteredPeople.map((person) => {
            ...
            const personHref = `/on-call?${new URLSearchParams({
